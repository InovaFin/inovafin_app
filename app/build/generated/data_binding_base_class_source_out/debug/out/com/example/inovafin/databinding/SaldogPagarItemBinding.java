...
public final class SaldogPagarItemBinding implements ViewBinding {
  @NonNull
  ...
  private SaldogPagarItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView checkbox,
  ...
  @NonNull
  public static SaldogPagarItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SaldogPagarItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.saldog_pagar_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SaldogPagarItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SaldogPagarItemBinding((LinearLayout) rootView, checkbox, checkboxSelected,
