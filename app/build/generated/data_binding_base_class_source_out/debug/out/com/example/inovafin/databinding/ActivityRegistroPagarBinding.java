...
public final class ActivityRegistroPagarBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageView btPagar;
  ...
  private ActivityRegistroPagarBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView btEditar, @NonNull ImageView btExcluir, @NonNull ImageView btPagar,
  ...
  @NonNull
  public static ActivityRegistroPagarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRegistroPagarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_registro_pagar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRegistroPagarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btPagar;
      ImageView btPagar = ViewBindings.findChildViewById(rootView, id);
      if (btPagar == null) {
        break missingId;
      }
      ...
      return new ActivityRegistroPagarBinding((RelativeLayout) rootView, btEditar, btExcluir,
          btPagar, contaRegistro, descRegistro, icFechar, nomeRegistro, valorRegistro,
          vencimentoRegistro);
    }
