...
public final class ActivityAjudaSaldoGeralBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityAjudaSaldoGeralBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAjudaSaldoGeralBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_ajuda_saldo_geral, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAjudaSaldoGeralBinding bind(@NonNull View rootView) {
