...
public final class ValorReceberItemBinding implements ViewBinding {
  @NonNull
  ...
  private ValorReceberItemBinding(@NonNull LinearLayout rootView,
      @NonNull TextView exibirDataReceber, @NonNull TextView exibirNomeReceber,
  ...
  @NonNull
  public static ValorReceberItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ValorReceberItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.valor_receber_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ValorReceberItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ValorReceberItemBinding((LinearLayout) rootView, exibirDataReceber,
