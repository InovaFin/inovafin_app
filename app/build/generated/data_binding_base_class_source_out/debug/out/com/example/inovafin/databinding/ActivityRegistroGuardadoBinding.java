...
public final class ActivityRegistroGuardadoBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityRegistroGuardadoBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityRegistroGuardadoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRegistroGuardadoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_registro_guardado, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRegistroGuardadoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegistroGuardadoBinding((RelativeLayout) rootView, btEditar, btExcluir,
