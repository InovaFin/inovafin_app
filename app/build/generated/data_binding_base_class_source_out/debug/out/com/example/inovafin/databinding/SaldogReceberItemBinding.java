...
public final class SaldogReceberItemBinding implements ViewBinding {
  @NonNull
  ...
  private SaldogReceberItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView checkbox,
      @NonNull ImageView checkboxSelected, @NonNull TextView exibirDataReceber,
      @NonNull TextView exibirNomeReceber, @NonNull TextView exibirValorReceber) {
  ...
  @NonNull
  public static SaldogReceberItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SaldogReceberItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.saldog_receber_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SaldogReceberItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SaldogReceberItemBinding((LinearLayout) rootView, checkbox, checkboxSelected,
          exibirDataReceber, exibirNomeReceber, exibirValorReceber);
    }
