...
import com.example.inovafin.databinding.ActivityEditarPagarBinding
...
class EditarPagar : AppCompatActivity() {

    private lateinit var binding: ActivityEditarPagarBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditarPagarBinding.inflate(layoutInflater)
        ...
        firestore.collection("Usuarios").document(usuarioId)
            ...
            .addSnapshotListener { document, error ->
                if (document != null) {
                    ...
                    binding.nomePagar.setText(nome)
                    binding.descricao.setText(desc)
                    binding.valorPagar.setText(valorFormatado)
    ...
    private fun formatandoSaldo() {
        val editTextMonetario = binding.valorPagar
    ...
    private fun verificarSaldo() {
        val valor = binding.valorPagar.text.toString()
    ...
    private fun validarCampos() {
        val nome = binding.nomePagar.text.toString()
        verificarSpinner()
        verificarSaldo()
