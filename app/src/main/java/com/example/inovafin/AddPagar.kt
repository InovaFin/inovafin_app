...
class AddPagar : AppCompatActivity() {

    private lateinit var binding: ActivityAddPagarBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddPagarBinding.inflate(layoutInflater)
    ...
    private fun adicionarRegistro() {
        ...
        firestore.collection("Usuarios").document(usuarioId)
            .collection("ContasPagar").document()
            .set(registroMasp)
