...
class EditarReceber : AppCompatActivity() {

    private lateinit var binding: ActivityEditarReceberBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditarReceberBinding.inflate(layoutInflater)
        ...
        firestore.collection("Usuarios").document(usuarioId)
            ...
            .addSnapshotListener { document, error ->
                if (document != null) {
                    ...
                    binding.nomeReceber.setText(nome)
                    binding.descricao.setText(desc)
                    binding.valorReceber.setText(valorFormatado)
