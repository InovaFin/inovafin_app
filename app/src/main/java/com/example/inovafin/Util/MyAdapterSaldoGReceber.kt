...
class MyAdapterSaldoGReceber(private val listaReceber : ArrayList<RegistroSaldoGReceber>, private val itemClickListener: (RegistroSaldoGReceber) -> Unit) : RecyclerView.Adapter<MyAdapterSaldoGReceber.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.saldog_receber_item,
            parent, false)
